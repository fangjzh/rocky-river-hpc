...
##### get info 
lsdef -t osimage rocky8.4-x86_64-netboot-compute
## if osimage def is not ok
##chdef -t osimage  rocky8.4-x86_64-netboot-compute pkglist=/opt/xcat/share/xcat/netboot/rocky/compute.rocky8.pkglist exlist=/opt/xcat/share/xcat/netboot/rocky/compute.rocky8.exlist
# Save chroot location for compute image
export CHROOT=/install/netboot/rocky8.4/x86_64/compute
# Build initial chroot image
genimage rocky8.4-x86_64-netboot-compute
...
nodeset compute osimage=rocky8.4-x86_64-netboot-compute
